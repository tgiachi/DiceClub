...
namespace DiceClub.Database.Migrations
{
    ...
    [Migration("20221113164400_addedInventoryPublisher")]
    partial class addedInventoryPublisher
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DiceClub.Database.Entities.Inventory.InventoryEntity", b =>
                {
                    ...
                    b.Property<DateTime?>("SoldDateTime")
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("sold_date_time");

                    b.Property<string>("SoldMarket")
                        .HasColumnType("text")
                        .HasColumnName("sold_market");
